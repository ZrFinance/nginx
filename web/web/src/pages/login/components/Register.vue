      ...
      <div class="user1">
        ...
        <div class="user2">
          ...
          <div class="user-group">
            ...
            <input class="input" type="password" placeholder="登入密码" v-model="passwd">
          </div>
          <div class="user-group">
            <img class="img" src="@/assets/img/icon-form-pwd.png">
            <input class="input" type="password" placeholder="二级密码" v-model="paypasswd">
          </div>
          <div class="user-group">
            <img class="img" src="@/assets/img/icon-form-user.png">
            <input class="input" type="text" placeholder="推荐人手机号" v-model="mobile1">
          </div>
          <div class="vercode">
        ...
        <div class="user3">
          <input class="input" type="submit" value="申请注册" @click="Register">
          <ul class="ul">
...
import { getSmsCode, register } from '@/api/request/request'
...
export default {
  ...
  data () {
    return {
      ...
      login_pg: require('@/assets/img/login-bg.jpg')
    }
  },
  computed: {
  ...
  methods: {
    ...
    Register: function () {
      ...
      if ( checkVoid(this.passwd, '请输入登录密码!') ) {
        return
      }
      if ( checkVoid(this.paypasswd, '请输入二级密码!') ) {
        return
      }
      if ( checkVoid(this.mobile1, '请输入推荐人手机号/用户名!') ) {
        return
      }
      ...
      register({
        mobile: this.mobile,
        referee_name: this.mobile1,
        passwd: this.$md5(this.passwd),
        pay_passwd: this.$md5(this.paypasswd),
  ...
  mounted () {
    if ( this.$route.params.username === '0' ){
      ...
      this.mobile1=this.$route.params.username
    }
  }
}
</script>
