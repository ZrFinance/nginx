  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        ...
        <el-form-item >
          <el-input v-model="filters.mobile" placeholder="提供会员"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" v-on:click="BymobileQuery">查询</el-button>
        </el-form-item>
        <el-form-item >
          <el-input v-model="filters.amount" placeholder="提供金额"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" v-on:click="ByamountQuery">查询</el-button>
        </el-form-item>
      </el-form>
    </el-col>
    ...
    <el-table 
      ...
      <el-table-column prop="name" label="姓名" width="200" sortable align="center">
      </el-table-column>
      <el-table-column prop="isday" label="排队天数" width="200" sortable align="center">
      </el-table-column>
      <el-table-column prop="updtime" label="提供时间" width="200" sortable align="center">
      </el-table-column>
...
<script>
import { requestTgbz,requestDelOrder,requestMatchAdd,requestOrderSplit } from '@/api/request/request';
...
export default {
  ...
  methods: {
    ...
    callBackrequestOrderSplit(){
      ...
      requestTgbz({page:this.page,flag:this.value,mobile:this.filters.mobile},this.callBackrequestTgbz)
    },
    ...
    batchLinkPool(){
      this.$confirm('确认将选中记录添加到匹配池吗？', '提示', {
        ...
        requestMatchAdd({ordercodes:ordercodes,trantype:0},this.callBackbatchLinkPool,this.callBackbatchLinkPoolError)
      }).catch(() => {
    ...
    callBackhandleDel(res){
      requestTgbz({},this.callBackrequestTgbz)
      this.listLoading = false;
    },
    handleDel(row){
    ...
    HandleSelectChange(){
      requestTgbz({flag:this.value},this.callBackrequestTgbz)
    },
    BymobileQuery(){
      requestTgbz({flag:this.value,mobile:this.filters.mobile},this.callBackrequestTgbz)
    },
    ByamountQuery(){
      requestTgbz({flag:this.value,amount:this.filters.amount},this.callBackrequestTgbz)
    },
