      ...
      <div class="user1">
        ...
        <div class="user2">
          ...
          <div class="user-group">
            ...
            <input class="input" type="password" placeholder="新的密码" v-model="passwd">
          </div>
          <div class="vercode">
...
import { getSmsCode, reset_passwd } from '@/api/request/request'
